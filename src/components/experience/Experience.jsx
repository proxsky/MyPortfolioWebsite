...
import UOFL from "../../assets/uofl.png"
import ANDROID from "../../assets/android.png"
import JAVS from "../../assets/javs.png"
      ...
      <div className="experience__sections">
        <div className="experience__content">
          ...
          <div className="experience__data">
            ...
            <div>
            <div className="skills__data">
            <img src={ANDROID} className="icon__size_experience"/>
          ...
          <div>
          <div className="skills__data">
            <img src={UOFL} className="icon__size_experience"/>
          ...
          <div className="experience__data">
            ...
            <div>
            <div className="skills__data">
            <img src={JAVS} className="icon__size_experience"/>
